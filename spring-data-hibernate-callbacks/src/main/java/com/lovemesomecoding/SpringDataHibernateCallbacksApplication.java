...
public class SpringDataHibernateCallbacksApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringDataHibernateCallbacksApplication.class, args);
	}
	@PostConstruct
    public void init() {
    ...
    public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
        return args -> {
            ...
            try {
                ...
                System.out.println("************************ Spring data - hibernate callback functions ***************************");
