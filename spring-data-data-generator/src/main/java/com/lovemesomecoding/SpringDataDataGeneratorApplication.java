...
import com.lovemesomecoding.loader.CustomerLoader;

@SpringBootApplication
public class SpringDataDataGeneratorApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringDataDataGeneratorApplication.class, args);
	}
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			try {
				...
				System.out.println("************************ Spring Data - Store ***************************");
